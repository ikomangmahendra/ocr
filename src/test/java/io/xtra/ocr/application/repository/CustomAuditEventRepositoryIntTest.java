...
import io.xtra.ocr.application.config.audit.AuditEventConverter;
import io.xtra.ocr.application.domain.PersistentAuditEvent;
...
import static io.xtra.ocr.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
