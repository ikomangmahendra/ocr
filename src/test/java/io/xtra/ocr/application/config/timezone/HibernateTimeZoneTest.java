package io.xtra.ocr.application.config.timezone;

import io.xtra.ocr.application.XtraOcrApp;
import io.xtra.ocr.application.repository.timezone.DateTimeWrapper;
import io.xtra.ocr.application.repository.timezone.DateTimeWrapperRepository;
