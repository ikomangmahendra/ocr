package io.xtra.ocr.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.xtra.ocr.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.xtra.ocr.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
